...
fn bind_action(cx: &mut App, keystroke: &str, action_name: &str, context: Option<&str>) -> bool {
    ...
    match action_name {
        ...
        "zqlz::ExplainAnalyzeQuery" => bind!(ExplainAnalyzeQuery),
        "zqlz::ExplainAnalyzeSelection" => bind!(ExplainAnalyzeSelection),
        ...
        "zqlz::ShowSchemaInspector" => bind!(ShowSchemaInspector),
        "zqlz::ShowCellEditorInspector" => bind!(ShowCellEditorInspector),
        "zqlz::ShowKeyEditorInspector" => bind!(ShowKeyEditorInspector),
        "zqlz::ShowQueryHistoryInspector" => bind!(ShowQueryHistoryInspector),
        ...
        "editor::DeleteWordLeft" => bind!(editor::DeleteWordLeft),
        "editor::DeleteWordRight" => bind!(editor::DeleteWordRight),
        "editor::JumpToMatchingBracket" => bind!(editor::JumpToMatchingBracket),
        ...
        "editor::DeleteToPreviousWordStart" => bind!(editor::DeleteWordLeft),
        "editor::DeleteToNextWordEnd" => bind!(editor::DeleteWordRight),
