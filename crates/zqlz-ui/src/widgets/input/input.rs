...
use crate::widgets::input::clear_button;
...
impl RenderOnce for Input {
    fn render(self, window: &mut Window, cx: &mut App) -> impl IntoElement {
        ...
        tracing::trace!(
            is_code_editor = state.mode.is_code_editor(),
        ...
        div()
            ...
            .flex()
            .key_context(crate::widgets::input::CONTEXT)
            ...
            .when(!state.disabled, |this| {
                this.on_action(window.listener_for(&self.state, InputState::backspace))
                    ...
                    .when(state.mode.is_multi_line() || state.emit_tab_event, |this| {
                        this.on_action(window.listener_for(&self.state, InputState::indent_inline))
                            .on_action(window.listener_for(&self.state, InputState::outdent_inline))
                    })
                    .when(state.mode.is_multi_line(), |this| {
                        this.on_action(window.listener_for(&self.state, InputState::indent_block))
