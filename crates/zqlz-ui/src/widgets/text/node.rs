...
// NOTE: This From implementation is commented out because markdown::mdast API was removed in new Zed version
// The pulldown_cmark::Alignment enum should be used instead when markdown parsing is rewritten
// See task-1.2 notes in PRD
/*
