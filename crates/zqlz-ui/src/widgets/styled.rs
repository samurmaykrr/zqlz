...
pub trait StyledExt: Styled + Sized {
    ...
    fn debug_red(self) -> Self {
        if cfg!(debug_assertions) {
            self.border_1().border_color(crate::widgets::red_500())
        } else {
            self
        }
    }
    ...
    fn debug_blue(self) -> Self {
        if cfg!(debug_assertions) {
            self.border_1().border_color(crate::widgets::blue_500())
        } else {
            self
        }
    }
    ...
    fn debug_yellow(self) -> Self {
        if cfg!(debug_assertions) {
            self.border_1().border_color(crate::widgets::yellow_500())
        } else {
            self
        }
    }
    ...
    fn debug_green(self) -> Self {
        if cfg!(debug_assertions) {
            self.border_1().border_color(crate::widgets::green_500())
        } else {
            self
        }
    }
    ...
    fn debug_pink(self) -> Self {
        if cfg!(debug_assertions) {
            self.border_1().border_color(crate::widgets::pink_500())
        } else {
            self
        }
    }
