...
pub trait TableDelegate: Sized + 'static {
    ...
    /// Called before context_menu to provide the currently selected row indices.
    /// Delegates can store this to use in context menu on_click handlers.
    /// Default implementation does nothing.
    fn set_context_menu_selection(&mut self, _selected_rows: Vec<usize>) {}
    ...
    /// Get the text content of a cell for copying to clipboard.
    ///
    /// Default implementation returns empty string.
    /// Override this to provide actual cell values for copy/paste.
    ...
    ///
    /// When true, row selection and other table interactions may be disabled
    /// to prevent conflicts with the active editor (e.g., dropdown, input field).
    ///
    /// Default: false
