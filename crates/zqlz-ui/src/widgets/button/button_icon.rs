use crate::widgets::{Icon, Sizable, Size, progress::ProgressCircle, spinner::Spinner};
...
impl ButtonIcon {
    ...
    pub fn loading_icon(mut self, icon: Option<Icon>) -> Self {
