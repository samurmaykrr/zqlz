...
impl AlertVariant {
    ...
    fn bg(&self, cx: &App) -> Hsla {
        match self {
            ...
            Self::Info => cx.theme().info.opacity(0.04),
            Self::Success => cx.theme().success.opacity(0.04),
            Self::Warning => cx.theme().warning.opacity(0.04),
            Self::Error => cx.theme().danger.opacity(0.04),
        }
    }
    ...
    fn border_color(&self, cx: &App) -> Hsla {
        match self {
            ...
            Self::Info => cx.theme().info.opacity(0.3),
            Self::Success => cx.theme().success.opacity(0.3),
            Self::Warning => cx.theme().warning.opacity(0.3),
            Self::Error => cx.theme().danger.opacity(0.3),
        }
    }
}
