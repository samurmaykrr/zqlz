use crate::widgets::{ActiveTheme, Sizable, Size};
use gpui::{
...
impl Clone for Icon {
    fn clone(&self) -> Self {
        ...
        this.preserve_colors = self.preserve_colors;
        this
    }
}
...
impl Icon {
    ...
    /// Preserve the original colors in the SVG file instead of applying text_color.
    /// This is useful for colored logos and icons.
...
impl RenderOnce for Icon {
    fn render(self, window: &mut Window, _cx: &mut App) -> impl IntoElement {
        ...
        *base.style() = self.style;
        ...
        // When preserve_colors is true, we still need to set a text_color for SVG elements
        // that use currentColor. We use the default text color but the SVG's explicit fills
        // should take precedence for paths that have them defined.
