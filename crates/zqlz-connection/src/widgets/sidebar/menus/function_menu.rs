//! Context menu for database function nodes
//!
//! This module provides the right-click context menu for function items in the sidebar.
...
impl ConnectionSidebar {
    ...
    ///
    /// This menu appears when right-clicking on a function node.
    pub(in crate::widgets) fn show_function_context_menu(
        &mut self,
        conn_id: Uuid,
