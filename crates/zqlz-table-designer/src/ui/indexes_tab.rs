    ...
    let index_data: Vec<_> = this
        ...
        .map(|(idx, index)| {
            (
                ...
                index.is_unique,
                this.index_name_inputs.get(idx).cloned(),
                this.index_columns_inputs.get(idx).cloned(),
                this.index_type_inputs.get(idx).cloned(),
                this.index_where_inputs.get(idx).cloned(),
                this.index_include_inputs.get(idx).cloned(),
            )
        })
        .collect();
